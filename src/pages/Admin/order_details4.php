        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-1 custom-width" style="height:100vh;">
                ...
                <div class="sidebar" style="height:100vh;">
                    ...
                    <a href="order_details4.php?logout=1" class="item">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                            ...
                            <div class="upper-buttons">
                                 <a href="orders.php" class="btn btn-primary" style="margin-top:10px;"><i class="fa-solid fa-arrow-left"></i>  Back</a>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <div style="padding:10px 0 0 30px">
                                                    ...
                                                    <p>Delivered Date: <?php echo $deliveryDate; ?></p>
                                                    <p>Delivered Time: <?php echo $deliveryTime; ?></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
