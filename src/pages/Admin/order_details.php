...
"Your order is now being prepared. We\'re carefully putting it together with the best ingredients for a great experience. Thanks for your patience, we\'ll have it ready for you soon!";
    $image = "preparing.png";
    $status = "unread";
    $sql3 = "INSERT INTO msg_users (uid, title, category, description, image, status) VALUES ('$uid', '$title', '$category', '$description', '$image', '$status')";
        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-1 custom-width" style="height:100vh;">
                ...
                <div class="sidebar" style="height:100vh;">
                    ...
                    <a href="order_details.php?logout=1" class="item">
                                        ...
                                        <div class="edit2">
                                            <form action="" method="post">
                                                ...
                                                <button type="submit" class="btn btn-primary"
                                                    ...
                                                    <i class="fa-solid fa-check"></i> Prepare Order
                                                </button>
                                                <?php endif; ?>
                                            </form>
                                        </div>
