...
<head>
    ...
    <link rel="stylesheet" href="css/logs3.css">
        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-1 custom-width" style="height:100vh;">
                ...
                <div class="sidebar" style="height:100vh;">
                    ...
                    <a href="order-preparing.php?logout=1" class="item">
            ...
            <div class="col-sm-11 wrap" style="padding:15px; height:100vh;">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="wrapper">
                            <h2><i class="fa-solid fa-file" style="margin-left:5px;"></i> Preparing Orders</h2>
                        ...
                        ?>
                            ...
                            $dbname = "ph_db";  
                            $conn = new mysqli($servername, $username, $password, $dbname);     
                            $sql = "SELECT * FROM orders WHERE status = 'preparing'";      
                            ...
                            $time = $dateTime->format("h:i A");
                                    ...
                                    echo "<div style='text-align:center;'><a href='order_details1.php?order_id=" . $row["orderID"]. "' class='btn btn-primary'>View Order</a></div>";
                                    echo "</div>";
                                    echo "</div>";
                                }
                            } else {
