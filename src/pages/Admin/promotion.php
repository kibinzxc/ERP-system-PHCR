...
if (isset($_POST['createPromotion'])) {
    ...
    // Insert promotion into the messages table
    $sql = "INSERT INTO messages (title, category, description, image) VALUES ('$title', 'Promotion', '$description', '$target')";
        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-11 wrap" style="padding:15px; height:100vh;">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="wrapper">
                           <h2><i class="fa-solid fa-pen-to-square" style="margin-left:5px;"></i> Create Promotion</h2>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group row" style="padding:50px 400px 20px 400px;">
                                    ...
                                    <div class="col-sm-10" style="margin-bottom:20px;">
                                        <input type="text1" class="form-control" id="title" name="title" required>
                                    </div>
