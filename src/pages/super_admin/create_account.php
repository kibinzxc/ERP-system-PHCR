...
if (isset($_POST['createPromotion'])) {
    ...
    $sql = "INSERT INTO users (email, password, user_type) VALUES ('$email', '$hashed_password', '$user_type')";
    if ($conn->query($sql) === TRUE) {
        $_SESSION['update'] = "Account created successfully";
        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-11 wrap" style="padding:15px; height:100vh;">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="wrapper">
                           <h2><i class="fa-solid fa-pen-to-square" style="margin-left:5px;"></i> Create Account</h2>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group row" style="padding:50px 400px 20px 400px;">
                                    ...
                                    <div class="col-sm-10" style="margin-bottom:20px;">
                                        <input type="text1" class="form-control" id="title" name="email" required>
                                    </div>
                                    ...
                                    <div class="col-sm-10" style="margin-bottom:20px;">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="createPromotion">Create Account</button>
