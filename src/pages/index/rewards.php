        ...
        <div class = "row row-flex"> <!-- Add the row-flex class -->
            <div class = "col-sm-1 custom-width"> <!-- Add the custom-width class -->
                <div class="sidebar">
                    ...
                    <a href="rewards.php" class="item-last active">
                    ...
                    <?php if ($loggedIn) : ?>
                        ...
                        <a href="rewards.php?logout=1" class="item">
                    ...
                    <div class = "row">
                        <div class = "col-sm-11">
                            <div class="search-container">
                                <input type="text" id="searchInput" placeholder="Searching for rewards to claim?">
